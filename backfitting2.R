...
par(mfrow=c(3,2))
for (i3 in 1:(i-1)){
  plot(fh1_aic[,i3],type="l", ylim=c(min(f1),max(f1)),col = rgb(red = 0, green = 0, blue = 0, alpha = 0.2),main="f1 for AICc",xlab="z1",ylab="f(z1)")
  par(new=TRUE)
  plot(f1,type="l",col=2,main="f1 for AICc",xlab="z1",ylab="f(z1)")
  par(new=TRUE)
}
par(new=FALSE)
for (i3 in 1:(i-1)){
  plot(fh2_aic[,i3],type="l", ylim=c(min(f2)-2,max(f2)),col = rgb(red = 0, green = 0, blue = 0, alpha = 0.2),main="f2 for AICc",xlab="z2",ylab="f(z2)")
  par(new=TRUE)
  plot(f2,type="l",col=3, ylim=c(min(f2)-2,max(f2)),main="f2 for AICc",xlab="z2",ylab="f(z2)")
  par(new=TRUE)
}
par(new=FALSE)
for (i3 in 1:(i-1)){
  plot(fh1_gcv[,i3],type="l", ylim=c(min(f1)-2,max(f1)),col = rgb(red = 0, green = 0, blue = 0, alpha = 0.2),main="f1 for GCV",xlab="z1",ylab="f(z1)")
  par(new=TRUE)
  plot(f1,type="l",col=3, ylim=c(min(f1)-2,max(f1)),main="f1 for GCV",xlab="z1",ylab="f(z1)")
  par(new=TRUE)
}
par(new=FALSE)
for (i3 in 1:(i-1)){
  plot(fh2_gcv[,i3],type="l", ylim=c(min(f2)-2,max(f2)),col = rgb(red = 0, green = 0, blue = 0, alpha = 0.2),main="f2 for GCV",xlab="z2",ylab="f(z2)")
  par(new=TRUE)
  plot(f2,type="l",col=3, ylim=c(min(f2)-2,max(f2)),main="f2 for GCV",xlab="z2",ylab="f(z2)")
  par(new=TRUE)
}
par(new=FALSE)
for (i3 in 1:(i-1)){
  plot(fh1_cp[,i3],type="l", ylim=c(min(f1)-2,max(f1)),col = rgb(red = 0, green = 0, blue = 0, alpha = 0.2),main="f1 for Cp",xlab="z1",ylab="f(z1)")
  par(new=TRUE)
  plot(f1,type="l",col=3, ylim=c(min(f1)-2,max(f1)),main="f1 for Cp",xlab="z1",ylab="f(z1)")
  par(new=TRUE)
}
par(new=FALSE)
for (i3 in 1:(i-1)){
  plot(fh2_cp[,i3],type="l", ylim=c(min(f2)-2,max(f2)),col = rgb(red = 0, green = 0, blue = 0, alpha = 0.2),main="f2 for Cp",xlab="z2",ylab="f(z2)")
  par(new=TRUE)
  plot(f2,type="l",col=3, ylim=c(min(f2)-2,max(f2)),main="f2 for Cp",xlab="z2",ylab="f(z2)")
  par(new=TRUE)
}
par(new=FALSE)

coefs <- matrix(c(beta,betai_aic,betai_gcv,betai_cp),2,4)
colnames(coefs) <- c("real_Beta","AICc","GCV","Cp")
coefs
